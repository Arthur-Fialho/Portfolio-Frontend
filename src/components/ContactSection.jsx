  ...
  const contactMethods = [
    {
      ...
      icon: <FaEnvelope className="text-2xl text-brand-light dark:text-emerald-400" />,
      actionText: 'Enviar email',
      bgColor: 'group-hover:bg-brand-light/10'
    },
    {
      name: 'GitHub',
      value: 'Arthur-Fialho',
      href: 'https://github.com/Arthur-Fialho',
      icon: <FaGithub className="text-2xl text-emerald-600 dark:text-emerald-300" />,
    ...
    },
    {
      ...
      icon: <FaLinkedin className="text-2xl text-brand-med dark:text-emerald-400" />,
      actionText: 'Conectar',
      bgColor: 'group-hover:bg-brand-med/10'
    }
  ];
      ...
      <div className="container mx-auto px-4 max-w-5xl relative z-10">
        <div className="text-center mb-16 space-y-4">
          <h2 className="text-4xl sm:text-5xl font-extrabold tracking-tight">
            Entre em <span className="bg-gradient-to-r from-brand-med to-brand-light bg-clip-text text-transparent">Contato</span>
          </h2>
        ...
        <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-8">
          {contactMethods.map((method, index) => (
            ...
            >
              ...
              <span className="mt-2 text-xs font-semibold text-brand-light dark:text-emerald-400 group-hover:underline">
                {method.actionText} →
              </span>
            </a>
          ))}
